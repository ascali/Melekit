    ...
    {    	
        ...
        if (count($check) == '1') {
            foreach ($check as $check) {
                    ...
                    $nama      = $check['nama'];   //mengambil data(level/hak akses) dari database
                    $email      = $check['email'];   //mengambil data(level/hak akses) dari database
                    $update      = $check['update'];   //mengambil data(level/hak akses) dari database
                }
