                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea name="isi" rows="8" cols="40" class="form-control" required=""></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                            <select name="id_kategori_konten" id="kategori_konten" class="form-control kategori_konten">
                            </select>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3" id="label-photo">Upload Gambar Konten </label>
                            <div class="col-md-9">
