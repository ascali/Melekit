                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="url" placeholder=" Url Link" max="20" maxlength="20" class="form-control" type="text" required="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="target" placeholder=" target" max="20" maxlength="20" class="form-control" type="text" required="">
                                <span class="help-block"></span>
                            </div>
                        </div>
