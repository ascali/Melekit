                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">                               
                                <input name="nama" placeholder=" Nama Kemitraan" max="20" maxlength="20" class="form-control" type="text" required="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">                                
                                <input name="alamat" placeholder=" Alamat Kemitraan" max="20" maxlength="20" class="form-control" type="text" required="">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
