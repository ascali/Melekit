                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="kelas" placeholder="Nama Kelas" max="20" maxlength="20" class="form-control" type="text" required="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="tingkat_kelas" max="20" maxlength="20" placeholder="Tingkat Kelas" class="form-control" required="">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="wali_kelas" max="20" maxlength="20" placeholder="Wali Kelas" class="form-control" required="">
                                <span class="help-block"></span>
                            </div>
                        </div>
