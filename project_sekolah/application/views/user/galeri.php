        ...
        <div class="content container">
            <div class="page-wrapper">
                <header class="page-heading clearfix">
                    <h1 class="heading-title pull-left">Gallery <small>(with sidebar)</small></h1>
                            ...
                            <div class="row page-row">
                                <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                                    <div class="album-cover">
                                        <a href="<?=base_url();?>index/galeri_detail"><img class="img-responsive" src="<?=base_url();?>public/user/test/images/gallery/gallery-thumb-1.jpg" alt="" /></a>
                                        <div class="desc">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                                    <div class="album-cover">
                                        <a href="<?=base_url();?>index/galeri_detail"><img class="img-responsive" src="<?=base_url();?>public/user/test/images/gallery/gallery-thumb-2.jpg" alt="" /></a>
                                        <div class="desc">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                                    <div class="album-cover">
                                        <a href="<?=base_url();?>index/galeri_detail"><img class="img-responsive" src="<?=base_url();?>public/user/test/images/gallery/gallery-thumb-3.jpg" alt="" /></a>
                                        <div class="desc">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                                    <div class="album-cover">
                                        <a href="<?=base_url();?>index/galeri_detail"><img class="img-responsive" src="<?=base_url();?>public/user/test/images/gallery/gallery-thumb-4.jpg" alt="" /></a>
                                        <div class="desc">
                                            <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                            <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                        </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                                    <div class="album-cover">
                                        <a href="<?=base_url();?>index/galeri_detail"><img class="img-responsive" src="<?=base_url();?>public/user/test/images/gallery/gallery-thumb-5.jpg" alt="" /></a>
                                        <div class="desc">
                                            <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                            <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                        </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                                    <div class="album-cover">
                                        <a href="<?=base_url();?>index/galeri_detail"><img class="img-responsive" src="<?=base_url();?>public/user/test/images/gallery/gallery-thumb-6.jpg" alt="" /></a>
                                        <div class="desc">
                                            <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                            <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                        </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                                    <div class="album-cover">
                                        <a href="<?=base_url();?>index/galeri_detail"><img class="img-responsive" src="<?=base_url();?>public/user/test/images/gallery/gallery-thumb-7.jpg" alt="" /></a>
                                        <div class="desc">
                                            <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                            <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                        </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                                    <div class="album-cover">
                                        <a href="<?=base_url();?>index/galeri_detail"><img class="img-responsive" src="<?=base_url();?>public/user/test/images/gallery/gallery-thumb-8.jpg" alt="" /></a>
                                        <div class="desc">
                                            <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                            <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                        </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                                    <div class="album-cover">
                                        <a href="<?=base_url();?>index/galeri_detail"><img class="img-responsive" src="<?=base_url();?>public/user/test/images/gallery/gallery-thumb-9.jpg" alt="" /></a>
                                        <div class="desc">
                                            <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                            <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                        </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                                    <div class="album-cover">
                                        <a href="<?=base_url();?>index/galeri_detail"><img class="img-responsive" src="<?=base_url();?>public/user/test/images/gallery/gallery-thumb-10.jpg" alt="" /></a>
                                        <div class="desc">
                                            <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                            <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                        </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                                    <div class="album-cover">
                                        <a href="<?=base_url();?>index/galeri_detail"><img class="img-responsive" src="<?=base_url();?>public/user/test/images/gallery/gallery-thumb-11.jpg" alt="" /></a>
                                        <div class="desc">
                                            <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                            <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                        </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                                    <div class="album-cover">
                                        <a href="<?=base_url();?>index/galeri_detail"><img class="img-responsive" src="<?=base_url();?>public/user/test/images/gallery/gallery-thumb-12.jpg" alt="" /></a>
                                        <div class="desc">
                                            <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                            <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                        </div>
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item">
                                            ...
                                            <div class="row">
                                                ...
                                                <img class="profile col-md-4" src="<?=base_url();?>public/user/test/images/testimonials/profile-1.png" alt="">
                                            </div>                               
                                        </div><!--//item-->
                                        <div class="item">
                                            <blockquote class="quote">
                                            ...
                                            <div class="row">
                                                ...
                                                <img class="profile col-md-4" src="<?=base_url();?>public/user/test/images/testimonials/profile-2.png" alt="">
                                            </div>                 
                                        </div><!--//item-->
                                        <div class="item active">
                                            ...
                                            <div class="row">
                                                ...
                                                <img class="profile col-md-4" src="<?=base_url();?>public/user/test/images/testimonials/profile-3.png" alt="">
                                            </div>                 
                                        </div><!--//item-->
