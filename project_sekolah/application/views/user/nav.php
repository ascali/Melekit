            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item"><a href="<?=base_url();?>index/galeri">Struktur Organisasi</a></li>
                        <li class="nav-item"><a href="<?=base_url();?>index/profil">Profil</a></li>
                        <li class="nav-item"><a href="<?=base_url();?>index/galeri">Galeri</a></li>
