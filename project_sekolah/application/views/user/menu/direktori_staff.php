                ...
                <div class="page-content">
                    <div class="row page-row">
                        ...
                        <div class="content-wrapper col-md-10 col-sm-8">  
                            <div class="page-row">
                                <h3 class="has-divider text-highlight">All List Direktori Staff</h3>
                                <!-- <div class="table-responsive"> -->                      
                                <div class="panel-body">
                                    <div class="dataTable_wrapper">
                                    <table class="table table-striped table-bordered table-hover" style="width: 100%" id="direktori_staff">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>NIP</th>
