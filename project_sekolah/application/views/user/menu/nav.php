                ...
                <div class="navbar-collapse collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-submenu">
                                  ...
                                  <ul class="dropdown-menu">
                                    ...
                                    <li><a href="<?=base_url();?>index/kurikulum">Kurikulum</a></li>
                                    <li><a href="<?=base_url();?>index/kalender_akademik">Kalender Akademik</a></li>
                                  </ul>
                                </li>
                                <li><a href="<?=base_url();?>index/direktori_staff">Direktori Staff</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li><a href="<?=base_url();?>index/galeri">Foto</a></li>
                              <li><a href="<?=base_url();?>index/vidio">Vidio</a></li>
                            </ul>
                        </li>
                        <!-- Prestasi -->
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li><a href="<?=base_url();?>index/agenda">Agenda Sekolah</a></li>
                              <li><a href="<?=base_url();?>index/artikel">Artikel</a></li>
                              <li><a href="<?=base_url();?>index/berita">Berita</a></li>
                              <li><a href="<?=base_url();?>index/loker">Lowongan Kerja</a></li>
                            </ul>
                        </li>
                    </ul><!--//nav-->
                </div><!--//navabr-collapse-->
