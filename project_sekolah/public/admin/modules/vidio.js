...
$(document).ready(function(){
	 ...
	 table = $('#submenu').DataTable( {
		...
		"order": [],
			"ajax": {
						"url": "http://localhost/project_sekolah/administrator/vidio_data",
				        "type": "POST"
		        	},
		    "aoColumns": [	
		    				{
...
function del(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "http://localhost/project_sekolah/administrator/vidio_delete_data/"+ id,
            type: "POST",
            dataType: "JSON",
            success: function(dataRow)
            {
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "http://localhost/project_sekolah/administrator/vidio_insert_data";
    } else {
        url = "http://localhost/project_sekolah/administrator/vidio_update_data";
    }
