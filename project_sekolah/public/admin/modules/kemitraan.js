...
$(document).ready(function(){
	 ...
	 table = $('#kemitraan').DataTable( {
		"processing": true,
		"order": [],
			"ajax": {
						"url": "http://localhost/project_sekolah/administrator/kemitraan_data",
				        "type": "POST"
		        	},
		    "aoColumns": [	
                            {
...
function add()
{
    ...
    $('.modal-title').text('Form Input kemitraan'); // Set Title to Bootstrap modal title
    $('#btnSave').text('Save');
...
function edit(id)
{
    ...
    $.ajax({
        url : "http://localhost/project_sekolah/administrator/kemitraan_edit_data/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(dataRow)
        {
            ...
            $('.modal-title').text('Form Edit Kemitraan'); // Set title to Bootstrap modal title
...
function del(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "http://localhost/project_sekolah/administrator/kemitraan_delete_data/"+ id,
            type: "POST",
            dataType: "JSON",
            success: function(dataRow)
            {
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "http://localhost/project_sekolah/administrator/kemitraan_insert_data";
    } else {
        url = "http://localhost/project_sekolah/administrator/kemitraan_update_data";
    }
