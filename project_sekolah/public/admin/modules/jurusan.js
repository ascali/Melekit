...
$(document).ready(function(){
     ...
     table = $('#jurusan').DataTable( {
        ...
        "order": [],
            "ajax": {
                        "url": "http://localhost/project_sekolah/administrator/jurusan_data",
                        "type": "POST"
                    },
            "aoColumns": [  
                            {
...
function add()
{
    ...
    $('.modal-title').text('Form Input Jurusan'); // Set Title to Bootstrap modal title
    $('#btnSave').text('Save');
}
...
function edit(id)
{
    ...
    $.ajax({
        url : "http://localhost/project_sekolah/administrator/jurusan_edit_data/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(dataRow)
        {
            ...
            $('[name="detail_jurusan"]').val(dataRow.data.detail_jurusan);
            $('[name="lambang_jurusan"]').val(dataRow.data.lambang_jurusan);
            $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Form Edit Jurusan'); // Set title to Bootstrap modal title
...
function del(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "http://localhost/project_sekolah/administrator/jurusan_delete_data/"+ id,
            type: "POST",
            dataType: "JSON",
            success: function(dataRow)
            {
                ...
                reload_table();
                alert('Success Delete Data jurusan');
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "http://localhost/project_sekolah/administrator/jurusan_insert_data";
    } else {
        url = "http://localhost/project_sekolah/administrator/jurusan_update_data";
    }
